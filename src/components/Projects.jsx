...
//                 {hoveredIndex === index && (
//                   <div
//                     className="position-absolute d-flex flex-wrap align-items-center gap-2 w-100 h-md-10 h-xs-40 "
//                     style={{
//                       bottom: '0',
//                       marginBottom:'1.5rem',
//                       left: '0',
              ...
              <div className="position-relative d-flex flex-column align-items-center">
                ...
                {hoveredIndex === index && (
                  <div
                    ...
                    style={{
                      bottom: '35px', // Increased bottom spacing for mobile
                      left: '0',
                      zIndex: 10,
                      padding: '15px 20px',
                      overflowY: 'auto',
                    ...
                    {project.stack.map((tech, i) => (
                      <span
                        ...
                        style={{
                          ...
                          fontSize: window.innerWidth <= 576 ? '10px' : '12px', // Smaller text on mobile
                          whiteSpace: 'nowrap',
